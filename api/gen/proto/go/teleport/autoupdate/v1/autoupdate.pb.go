...
type AgentAutoUpdateGroup struct {
	...
	CanaryCount   int64 `protobuf:"varint,6,opt,name=canary_count,json=canaryCount,proto3" json:"canary_count,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AgentAutoUpdateGroup) GetCanaryCount() int64 {
	if x != nil {
...
const file_teleport_autoupdate_v1_autoupdate_proto_rawDesc = "" +
	...
	"\fcanary_count\x18\x06 \x01(\x03R\vcanaryCountJ\x04\b\x04\x10\x05R\twait_days\"\xd9\x01\n" +
